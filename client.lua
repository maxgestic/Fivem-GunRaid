...
RegisterNetEvent('usa_gunraid:hackattemptReturn')
...
RegisterNetEvent('usa_gunraid:hackattemptAlreadyHacking')
...
RegisterNetEvent('usa_gunraid:hackfailReturn')
...
RegisterNetEvent('usa_gunraid:PedInfo')
...
RegisterNetEvent('usa_gunraid:NoMoneyPed')
...
RegisterNetEvent('usa_gunraid:hackgateReturn')
...
RegisterNetEvent('usa_gunraid:verifycodeReturn')
